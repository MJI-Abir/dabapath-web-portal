        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                <BsPuzzle />
                <span className="flex-1 ml-3 whitespace-nowrap">Puzzle</span>
              </a>
            </li>
            <li>
              <a
            ...
            <li>
              ...
              >
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0 m7-1a1 1 0 100 2 1 1 0 000-2z"
                    clipRule="evenodd"
                  ></path>
                </svg>
            ...
            <li className="cursor-pointer" onClick={() => nav("login")}>
            ...
            <li className="cursor-pointer" onClick={() => nav("signUp")}>
              <div
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
              >
                <svg
          ...
          <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
            ...
            <li>
              ...
              >
                ...
                <span className="ml-3">On This Day</span>
              </a>
            </li>
            <li>
              <a
